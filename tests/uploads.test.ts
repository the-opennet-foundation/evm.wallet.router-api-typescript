import fs from 'fs';
import type { ResponseLike } from '@paxeer-network/evm.wallet.router-api/internal/to-file';
import { toFile } from '@paxeer-network/evm.wallet.router-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('@paxeer-network/evm.wallet.router-api/core/uploads');
    await expect(
