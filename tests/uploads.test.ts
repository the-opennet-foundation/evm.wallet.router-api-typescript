import fs from 'fs';
import type { ResponseLike } from 'evm.wallet.router-api/internal/to-file';
import { toFile } from 'evm.wallet.router-api/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('evm.wallet.router-api/core/uploads');
    await expect(
